...
const page = () => {
  return (
    ...
    <div className="w-ful flex justify-between gap-3 bg-blue-100">
    <div className="h-96 w-2/6 min-w-48 border bg-red-300">
      <LeftMenuApp className="w-full" />
    </div>
    <div className=" h-96 w-full  border bg-red-300"></div>
    <div className=" hidden md:flex h-96 w-2/6 min-w-48 border bg-red-300 "></div>
  </div>
  );
};
